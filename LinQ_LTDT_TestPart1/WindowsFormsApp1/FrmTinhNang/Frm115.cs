        ...
        public static List<string> listVertex = new List<string>()
{
    ...
    "Đèn đỏ Ngô Quyền - Chợ rẫy", //38
        ...
        /// <summary>
        /// Hàm khởi tạo 2 thuật toán Dijkstra và A*
        /// </summary>
        ...
        private Dictionary<string, string> diseaseHospitalMap = new Dictionary<string, string>()
    {
       ...
       { "Bệnh viện Quận 6",211},
        ...
        /// <summary>
        /// Lấy danh sách tên bệnh viện
        /// </summary>
        /// <returns>1 list string là tên các bệnh viện</returns>
        ...
        private void Form1_Load(object sender, EventArgs e)
            ...
            txtStreetName.AutoCompleteMode = AutoCompleteMode.SuggestAppend; 
        ...
        /// <summary>
        /// Sự kiện khi người dùng click vào nút Run
        /// </summary>
        ...
        /// <summary>
        /// Chọn ngẫu nhiên 1 xe cứu thương từ 1 bệnh viện
        /// </summary>
        /// <param name="HospitalStart">Tên bệnh viện</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Điều chỉnh database sau khi chọn xe cứu thương
        /// </summary>
        /// <param name="HospitalStart">Tên bệnh viện cử xe cứu thương đi</param>
        /// <param name="AmbuId">ID của xe cứu thương được chọn làm nhiệm vụ</param>
        ...
        /// <summary>
        /// Event hiển thị khi người dùng di chuột vào nút khẩn cấp
        /// </summary>
        ...
        /// <summary>
        /// ẩn lable đi sau khi người dùng di chuột ra nút khẩn cấp
        /// </summary>
        ...
        /// <summary>
        /// Hiển thị các button , combobox cho mô phỏng đợt 2
        /// </summary>
        ...
        /// <summary>
        /// Event cho button Run đối với mô phỏng đợt 2
        /// </summary>
        ...
        /// <summary>
        /// Thay thế các tính năng của các button sau khi mô phỏng đợt 1 kết thúc
        /// </summary>
        ...
        /// <summary>
        /// Khởi tại bộ thời gian đếm ngược tình huống khẩn cấp
        /// </summary>
        ...
        /// <summary>
        /// Kiểm tra xem người dùng có tương tác hay không
        /// </summary>
        ...
        /// <summary>
        /// tính năng quay về bệnh viện gần nhất cho nút khẩn cấp
        /// </summary>
        ...
        /// <summary>
        /// Sử dụng thuật toán để tìm ra bệnh viện gần nhất
        /// </summary>
        /// <param name="streetName">Tên đường xảy ra tai nạn</param>
        /// <returns>index của bệnh viện gần nhất</returns>
        ...
        /// </summary>
        /// <param name="startStreet">Tên đỉnh A</param>
        /// <param name="endStreet">Tên đỉnh B</param>
        /// <returns>danh sách các đỉnh trong đường đi ngắn nhất</returns>
        ...
        /// Tìm đường đi ngắn nhất giữa 2 đỉnh
        /// </summary>
        /// <param name="startIndex">Index của đỉnh 1</param>
        /// <param name="endIndex">Index của đỉnh 2</param>
        /// <returns>danh sách các đỉnh trong đường đi ngắn nhất</returns>
